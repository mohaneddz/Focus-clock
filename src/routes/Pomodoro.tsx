...
const order: Array<"focus" | "short" | "long"> = ["focus", "short", "long"];
...
export default function Pomodoro() {
  ...
  const shift = (direction: 1 | -1) => choose(order[(order.indexOf(mode()) + direction + order.length) % order.length]);
